...
hidden if the `vayunicus_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `vayunicus_DEVELOPER_MODE` to the configure
...
Runs the executable target `vayunicus_exe`.
